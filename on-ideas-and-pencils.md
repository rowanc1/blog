...
[^eloquence]: Maybe [eloquence is the key](http://www.thebookoflife.org/the-need-for-eloquence/)?

I think that it is this imperfect transmission of ideas that allows us to make progress. Ideas change minds, and get combined in a different environment, join up with preconceptions, and then move hosts get recreated, mutated slightly, and the process continues[^memetics].

[^memetics]: Sounds like a meme - or [memetics](https://en.wikipedia.org/wiki/Memetics) maybe.
...
>
> -- [The Book of Life](http://www.thebookoflife.org/the-need-for-eloquence/)
...
I think that this can only happen like this. We stand on the shoulders of giants. But now we are standing on the shoulders of so many giants standing on other giants[^newton]. We have this interdependent network of support below all of the work that we do. No one could function at the level we do in isolation. Think about it! No one person knows anything about anything. It is insane. There is an example about a pencil.

[^newton]: I find it hilarious that this saying might have come from Newton taking a [sarcastic jab](https://en.wikipedia.org/wiki/Standing_on_the_shoulders_of_giants#References_during_the_sixteenth_to_nineteenth_centuries) at Hooke's short stature.

:::{figure} images/on/pencils.png
[Milton Friedman](https://thenewinquiry.com/milton-friedmans-pencil/) introduced an [example of a pencil](https://www.youtube.com/watch?v=67tHtpac5ws) which [economists get very excited about](https://www.youtube.com/watch?v=Kw1kODe7eDU). \
Image from [Wikipedia CC-BY](https://commons.wikimedia.org/wiki/File:Macro_of_sharpened_colored_pencils_arranged_in_a_circle.jpg)
:::

It is pretty obvious that no one could actually make even a pencil. Not in isolation. The person who knows how to operate a graphite mine certainly does not know the finer points of manufacturing and how to make a global operation of pedaling small wooden sticks infused with carbon. In isolation we are hurting ourselves[^pencils].

[^pencils]: Maybe you need to see inside a [pencil factory](https://www.nytimes.com/2018/01/12/magazine/inside-one-of-americas-last-pencil-factories.html)?
