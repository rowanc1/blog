...
:::{note} Note
Kang, S., Heagy, L. J., Cockett, R., & Oldenburg, D. W. (2017). Exploring nonlinear inversions: A 1D magnetotelluric example. The Leading Edge, (August), 696-699. @doi:10.1190/tle36080696.1
:::

:::{figure} images/papers/mt-tutorial-thumbnail.png
Exploring nonlinear inversions: A 1D magnetotelluric example. [Read more](https://library.seg.org/doi/10.1190/tle36080696.1).
:::
